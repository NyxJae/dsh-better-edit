...
export const EDIT_DESCRIPTION =
  ...
  "On failure follow the error hint: `[MODEL]` errors need a retry with fresh anchors, `[USER]` notices are human-only. The optional result_format=structured form is for programmatic consumers.";
...
export const READ_DESCRIPTION =
  ...
  "Use format=records for PTC / run_code to receive ordered rows and pagination metadata.";
...
export const READ_GUIDANCE: ToolGuidance = {
  ...
  lines: [
    ...
    "`read`: direct use defaults to `HASH\u2502content`; the HASH is the anchor and there are no line numbers.",
    "`read`: inside PTC / `run_code`, pass format=records and consume rows directly instead of parsing rendered text.",
